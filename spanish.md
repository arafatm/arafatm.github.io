...
william, marilyn, andrea, vanessa, leigh anne, daria, lisa higuchi, emily
short, michelle oliva, alexis reale, jean, jay monk, monish, veronica neely,
kenneth, ceci, isabelle anderson, kyler
...
Preguntas
- Es El Televisor? 
  - No, senor, no es el televisor. Es el gato

- Que     = what
- Quien   = who
- Donde   = where
- Como es = what is, like
...
- la profesor = teacher
- una tiza    = whiteboard
- una alumna  = (fem) student
- una mesa    = table
- una fruta   = fruit
- un alumno   = (mas) student
- una puptre  = desk
- un papel    = paper
