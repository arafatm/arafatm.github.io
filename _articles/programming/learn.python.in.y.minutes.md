...
:bulb: that a tuple of length one has to have a comma after the last element but
...
Children automatically inherit their parent class's constructor including its
