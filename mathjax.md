# MathJax symbol reference | BrNk

source: https://www.bearnok.com/grva/it/knowledge/software/mathjax

[Mathjax plugin](https://github.com/sommerregen/grav-plugin-mathjax/blob/master/README.md)
...
| $${x_1}^e$$                                       | Superscripts (`^`) and subscripts (`_`)
| --------------------                              | __Fractions__
| $$\frac {a} {b}$$                                 | `\frac {a} {b}`
| $${ {x} \over {y} }$$                             | `{ {x} \over {y} }`
| --------------------                              | __Unscaled parentheses__
| $$(...)$$                                         | `(...)`
| $$[...]$$                                         | `[...]`
| $${ ... }$$                                       | `\{ ... \}`
| $$\vert ... \vert$$                               | `\vert ... \vert`
